...
\begin{figure}[htb]
  ...
  \begin{minipage}[t]{0.49\linewidth}\centering
    ...
    \centerline{(b)}
  \end{minipage}
  \caption{(a) IS spectrum ion line; and (b) corresponding ACF. With all O$^+$ ions, $N_e = 10^{11}$, $T_e=2500 ^\circ$ K and $T_i=1000 ^\circ$ K.}
  \label{fig:ispecch2}
\end{figure}
